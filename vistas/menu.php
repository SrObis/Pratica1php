      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            ?>
              <li><a href="usuarios.php"><span class="glyphicon glyphicon-user"></span> Administrar admins</a>
              </li>
            <?php
            endif;
            ?>
            ...
            <li><a href="clientes.php"><span class="glyphicon glyphicon-user"></span> Usuarios</a>
            </li>
